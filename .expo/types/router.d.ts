...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/(tabs)/tournaments/` | `/tournaments/` | `/(tabs)/tournaments` | `/(tabs)/user` | `/user` | `/modal`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(tabs)/tournaments/${SingleRoutePart<T>}` | `/tournaments/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(tabs)/tournaments/[id]`;
